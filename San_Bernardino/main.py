...
trial = 101
trial_desc = 'San Bernandino - vSCAN - 500epochs - max_kl_weight=0.05 - sigmoid annealing kl_Weights - train=1, val=0, test=2'
...
width=9
response=3
all_channel_address=[[0, 6, 2],[0, 6, 0], [0, 6, 1],[0, 0, 1],[2,6,0],[2,5,0],[2,6,1],[2,0,1],[5,6,0],[5,5,0],[5,6,1],[5,0,1]]
test_ids = [2]
val_ids = [0]
# eval_ids = [0,1]
train_avoid_ids = [0,2]
...
if test_model:
    ...
    plot_di_stoch_final(type_name, dir_name=dir_name, perc=95, fs=100)
    val_ui, ui = plot_ui_final(type_name, dir_name=dir_name, perc=95, fs=100)
    val_detections_rolling_1s, detections_rolling_1s = detections_rolling_stoch_final(type_name, dir_name=dir_name, perc=95, fs=100)
    val_detections_rolling_1s, detections_rolling_1s, ui_detections_rolling_1s = detections_rolling_ui(ui, val_ui, type_name, dir_name=dir_name, perc=95, fs=100)
