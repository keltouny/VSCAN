...
trial = 101
trial_desc = 'Sherman Oaks - vSCAN - 500epochs - max_kl_weight=0.05 - sigmoid annealing kl_Weights - train=2, val=0, test=1'
...
width=8
response=3
all_channel_address=[[8, 4, 0], [8, 4, 1], [8, 0, 1], [5, 4, 0], [5, 4, 1], [5, 0, 1], [2, 4, 0],
                  [2, 4, 1], [2, 0, 1], [1, 4, 0], [1, 4, 1],
                  [1, 0, 1], [0, 5, 0], [0, 5, 2], [0, 5, 1]]
test_ids = [1]
val_ids = [0]
train_avoid_ids = [0,1]
